            ...
            <div class="team-member-box team-member-${i+1}-box">
                ...
                <div class="member-details member-${i+1}-details">
                    <div class="name-college-gender">
                        <input type="text" name="member-${i+1}-name" id="member-${i+1}-name" class="member-${i+1}-name-input member-name-input" placeholder="Name" size="30" required><br>
                        <input type="text" name="member-${i+1}-college" id="member-${i+1}-college" class="member-${i+1}-college member-college" placeholder="College" size="30" required><br>
                        <div class="member-gender member-${i+1}-gender">
                            <div class="sex">Gender:</div>
                            <div class="male">
                                <input type="radio" name="member-${i+1}-gender" id="member-${i+1}-male" class="input-male" value="male" required>
